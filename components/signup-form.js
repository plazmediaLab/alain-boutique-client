  ...
  return (
    <form className="mx-auto bg-white w-4/6">
      ...
      <div className="mb-4 mt-8">
        <p className="block my-2 text-center font-light tracking-wider mb-6">
          Registrarse como:
        </p>

        <div className="flex items-center justify-around text-gray-400">
          <label className={`cursor-pointer flex items-center ${role === 'USER_ROLE' && 'text-alain-blue-500'}`}>
            <input 
              type="radio"
              name="empleoactual"
              value="USER_ROLE"
          ...
          <label className={`cursor-pointer flex items-center ${role === 'PARNERTH_ROLE' && 'text-alain-blue-500'}`}>
            <input 
              type="radio"
              name="empleoactual"
              value="mediodia"
        ...
        {role === 'USER_ROLE' && <small className="text-center block text-gray-500 leading-tight mt-2">Agrega tus productos, agrega socios, administra tus ventas y revisa tus ganancias.</small>}
        {role === 'PARNERTH_ROLE' && <small className="text-center block text-gray-500 leading-tight mt-2">Obten el resumen de ventas de tus productos administrados por tu vendedor.</small>}
